...
def algo1(d1, d2, T, R, X, Y, cov_X, eta, eps, r, lambd, task_function, iterations):
    # Save the original A and Z tensors
    # Step 1: Tensor regression
    print("lambda hyperparam = {}".format(lambd))
    B = batch_grad_descent(d1, d2, T, R, X, Y, cov_X, eta, eps, r, lambd, task_function, iterations, sparse=1)
